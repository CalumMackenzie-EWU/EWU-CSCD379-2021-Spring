...
namespace SecretSanta.EndToEnd.Tests
{
    ...
    public class EndToEndTests
    {
        ...
        public async Task CreateGift()
        {
            ...
            //cal: We dont have to worry about it for this asmt. But since the users are set up with js now we would need to do a await page.WaitForSelectorAsync("same tags as our QuerySelector") before each QuerySelector.
            //cal: This is because those things arent populate immediately, and may not have been generated by the js yet, so we need to wait for something to exist there first.
        }
