...
namespace SecretSanta.EndToEnd.Tests
{
    ...
    {
        public readonly Lazy<Uri> WebRootUriInitializer;//cal: I think we use lazy to lessen the overhead if this object is never called.
        ...
        protected override IHost CreateWebHost()
        {
            return new HostBuilder()
                ...
                .ConfigureWebHost(webHostBuilder => webHostBuilder
                    .UseKestrel()//cal: create a web host using kestrel
                    .UseSolutionRelativeContentRoot(Path.Combine("src", typeof(WStartup).Assembly.GetName().Name))//cal: find the relative path to our wwwroot folder
                    .UseStaticWebAssets()//cal: so it knows to use our wwwroot.
                    .UseStartup<WStartup>()//cal: use the Startup.cs we've defined.
